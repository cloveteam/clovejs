...
// A toy user table. Real apps look this up in a database and hash the password;
// kept plain here so the example stays about testing, not authentication. The
// override tests replace this whole service with a fake.
